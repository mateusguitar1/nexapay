...
class CheckHookPIXLuxTakNEW implements ShouldQueue
{
        ...
        if($transaction){
            ...
            if($payment_id == $transaction->code){
                ...
                try{
                    ...
                    $FunctionsController->registerRecivedsRequests("/var/www/html/fastpayments/logs/".$path_name."/luxtak.txt",json_encode($post_register));
