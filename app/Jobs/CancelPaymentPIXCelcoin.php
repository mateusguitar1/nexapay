...
class CancelPaymentPIXCelcoin implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    protected $transaction_id;
    protected $bank_withdraw_id;
    protected $description_error;
    protected $endtoend;
    public $tries = 1;
     ...
     * @return void
     */
    public function __construct($transaction_id,$bank_withdraw_id,$description_error,$endtoend)
    {
        //
    ...
    public function handle()
    {
        ...
        try{
            ...
            $transaction->update([
                ...
                'status' => 'canceled',
                'observation' => $this->description_error,
