...
class CheckHookPIXCelcoin implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if($transaction){
            ...
            $payment_id = $ck['RequestBody']['transactionIdBRCode'];
            $EndToEndId = $ck['RequestBody']['EndToEndId'];
            ...
            if($payment_id == $transaction->payment_id && $EndToEndId != null){
                ...
                try{
                    ...
                    $FunctionsController->registerRecivedsRequests("/var/www/html/fastpayments/logs/".$path_name."/celcoin.txt",json_encode($post_register));
