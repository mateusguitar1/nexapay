...
use App\Models\{Clients,Keys,Transactions,Banks,Webhook,Extract};

class ApproveHookPIXShipay implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($transaction_id,$webhook_id)
    {
        //
    ...
    public function handle()
    {
        ...
        if(isset($transaction)){
            ...
            $webhook = Webhook::where("id","=",$this->webhook_id)->first();
            ...
            if($order_id != null){
                ...
                try{
                    ...
                    $path_name = "send-webhook-merchant-shipay-".date("Y-m-d");
