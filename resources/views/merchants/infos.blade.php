...
@section('content')
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-9">
                <h1 class="m-0">Merchant Info</h1>
            </div><!-- /.col -->
            <div class="col-sm-3">
                {{ $data['model']->name}} | {{strtoupper($data['model']->currency) }}
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="card" style="padding:15px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <table>
                            <tr>
                                <td>Maximum = {{strtoupper($data['model']->currency)}} <span id="span_max_boleto">{{number_format($data['model']->tax->max_boleto,2,',','.')}}</span></td>
                            </tr>
                            <tr>
                                <td>Minimum = {{strtoupper($data['model']->currency)}} <span id="span_min_boleto">{{number_format($data['model']->tax->min_boleto,2,',','.')}}</span></td>
                            </tr>
                            <tr>
                                <td>Fee Paid ={{strtoupper($data['model']->currency)}} <span id="span_boleto_absolute">{{number_format($data['model']->tax->boleto_absolute,2,',','.')}}</span> + <span id="span_boleto_percent">{{number_format($data['model']->tax->boleto_percent,2,',','.')}}</span>%</td>
                            </tr>
                            <tr>
                                <td>Fee Unpaid ={{strtoupper($data['model']->currency)}} <span id="span_boleto_unpaid">{{number_format($data['model']->tax->boleto_cancel,2,',','.')}}</span></td>
                            </tr>
                            <tr>
                                <td>Due in: <span id="span_client_safe_boleto">{{$data['model']->days_safe_boleto}}</span> days</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <table>
                            <tr>
                                <td>Maximum = {{strtoupper($data['model']->currency)}} <span id="span_max_pix">{{number_format($data['model']->tax->max_pix,2,',','.')}}</span></td>
                            </tr>
                            <tr>
                                <td>Minimum = {{strtoupper($data['model']->currency)}} <span id="span_min_pix">{{number_format($data['model']->tax->min_pix,2,',','.')}}</span></td>
                            </tr>
                            <tr>
                                <td>Fee = {{strtoupper($data['model']->currency)}} <span id="span_pix_absolute">{{number_format($data['model']->tax->pix_absolute,2,',','.')}}</span> + <span id="span_pix_percent">{{number_format($data['model']->tax->pix_percent,2,',','.')}}</span>%</td>
                            </tr>
                            <tr>
                                <td>&nbsp</td>
                            </tr>
                            <tr>
                                <td>Due in: <span id="span_client_safe_pix">{{$data['model']->days_safe_pix}}</span> days</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <table>
                            <tr>
                                <td>Maximum = {{strtoupper($data['model']->currency)}} <span id="span_max_withdraw">{{number_format($data['model']->tax->max_withdraw,2,',','.')}}</span></td>
                            </tr>
                            <tr>
                                <td>Minimum = {{strtoupper($data['model']->currency)}} <span id="span_min_withdraw">{{number_format($data['model']->tax->min_withdraw,2,',','.')}}</span></td>
                            </tr>
                            <tr>
                                <td>Fee = {{strtoupper($data['model']->currency)}} <span id="span_withdraw_absolute">{{number_format($data['model']->tax->withdraw_absolute,2,',','.')}}</span> + <span id="span_withdraw_percent">{{number_format($data['model']->tax->withdraw_percent,2,',','.')}}</span> %</td>
                            </tr>
                    ...
                    <div class="col-sm-3">
                        ...
                        <table>
                            <tr>
                                <td> Remittance Fee = {{strtoupper($data['model']->currency)}} <span id="span_remittance_absolute">{{number_format($data['model']->tax->remittance_absolute,2,',','.')}}</span> + <span id="span_remittance_percent">{{number_format($data['model']->tax->remittance_percent,2,',','.')}}</span> %</td>
                            </tr>
                        </table>
                    </div>

                    <div class="col-sm-12 m-12" style="border:1px solid #dedede;margin:15px 0;"></div>
